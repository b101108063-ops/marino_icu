...
Magnesium is essential for energy utilization in the organic world. Magnesium is the heart of the chlorophyll molecule in green plants, which captures the radiant energy in sunlight and stores it in the carbon bonds that hold carbohydrates together. Aerobic organisms then transfer this energy to adenosine triphosphate (ATP), and the release of energy from ATP requires magnesium (which is an essential cofactor for ATPase enzymes). Thus, magnesium is essential for providing us with energy from the sun, and for allowing us to utilize this energy to sustain life.
