...
### Body Fluid Volumes in Adults

| Compartment | Derivation | Male (75 kg) | Female (60 kg) |
|:------------|:-----------|:-------------:|:--------------:|
| Total Body Water | 0.6 × LBW (M) / 0.5 × LBW (F) | 45 L | 30 L |
| Intracellular Volume | 0.65 × TBW | 29 L | 20 L |
| Extracellular Volume | 0.35 × TBW | 16 L | 10 L |
| Interstitial Volume | 0.8 × ECV | 13 L | 8 L |
| Plasma Volume | 0.2 × ECV | 3 L | 2 L |

*LBW = lean body weight, TBW = total body water, ECV = extracellular volume.*
...
|:---------|:------------:|:------:|
| Sodium | 154 mEq/L | 140 mEq/L |
| Chloride | 154 mEq/L | 103 mEq/L |
| Osmolality | 308 mOsm/L | 290 mOsm/L |
| pH | 5.7 | 7.4 |

**Key Point:** The predominant effect of 0.9% saline infusions is to expand the interstitial volume (825 mL) rather than the plasma volume (275 mL).

### The Evils of Chloride

1. **Hyperchloremic metabolic acidosis:** Due to the high chloride concentration
2. **Acute kidney injury:** From chloride-mediated renal vasoconstriction

### Crystalloid Fluid Comparisons

| Fluid | Sodium (mEq/L) | Chloride (mEq/L) | Lactate (mEq/L) | Osmolality (mOsm/L) |
|:------|:--------------:|:---------------:|:---------------:|:-------------------:|
| **Plasma** | 140 | 103 | 1–2 | 290 |
...
Ringer's lactate (RL) was developed by Alexis Hartmann in the 1930s. The sodium concentration is reduced to compensate for sodium from sodium lactate, and the chloride concentration (109 mEq/L) approximates plasma (103 mEq/L).

**Lactate as a Buffer:** Lactate is converted to glucose in the liver, which consumes hydrogen ions:

$$2 \text{ Lactate } + 2H^+ \rightarrow \text{ Glucose}$$

Each mmol of lactate generates 1 mmol of bicarbonate.
...
- Safe with blood transfusions

### Hypertonic Saline

Hypertonic saline solutions (e.g., 7.5% NaCl) are more effective at expanding extracellular volume. Infusion of 250 mL produces a 1,235 mL increase in extracellular fluid.

**Uses:**
- Limited-volume resuscitation of hemorrhagic shock
- Reducing intracranial pressure (ICP) in traumatic brain injury
...
- Molar substitution ratio: 0.4–0.7
- Higher ratios = prolonged action but increased adverse effects
...
- Hyperoncotic renal injury (rare)
...
3. Reddy S, Weinberg L, Young P. Crystalloid fluid therapy. *Critical Care* 2016; 20:59.
