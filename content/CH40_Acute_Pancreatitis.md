...
Acute pancreatitis is cited as one of the leading abdominal disorders that requires hospitalization (1), but most cases are not severe enough to warrant ICU admission. However, the cases that do require ICU admission are often (or quickly become) the sickest patients in the ICU.
