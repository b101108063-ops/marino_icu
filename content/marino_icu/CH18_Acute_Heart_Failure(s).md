...
儘管現代強調「心臟健康」生活方式，heart failure 的患病率和相關死亡率近年來有所增加。目前的調查顯示，美國每 8 例死亡中就有 1 例與 heart failure 相關，表明 heart failure 是該國的一個主要健康問題。

Heart failure 根據受累的心臟周期（收縮或舒張）和心臟受累側進行分類。本章描述各種類型的 heart failure，聚焦於 heart failure 的急性失代償期。

## Types of Heart Failure

Heart failure 可由心臟充盈受損（diastolic dysfunction）或收縮力量下降（systolic dysfunction）引起。
...
**Table 18.1** 基於左心室 Ejection Fraction（LVEF）的 Heart Failure 分類

| 類別 | LVEF | 問題 |
|---|---|---|
| **Heart Failure with preserved ejection fraction（HFpEF）** | ≥50% | Diastolic dysfunction |
| **Heart Failure with mildly reduced ejection fraction（HFmrEF）** | 41–49% | Systolic dysfunction（輕度） |
| **Heart Failure with reduced ejection fraction（HFrEF）** | ≤40% | Systolic dysfunction（中度/重度） |

## Natriuretic Peptides

**Table 18.2** 升高之 Natriuretic Peptide 水準的原因

| 心臟原因 | 非心臟原因 |
|---|---|
| Heart failure（右側和左側） | 高齡 |
| 心肌炎 | 腎衰竭 |
| 心室肥厚 | 貧血 |
| 急性冠狀動脈症候群 | 肺栓塞 |
| 心包疾病 | 肺高血壓 |
...
**Table 18.3** 急性 Heart Failure 的 Vasodilator 輸注
...
| **Nitroprusside** | 起始：0.2 μg/kg/min；每 5 分鐘滴定。有效劑量：2–5 μg/kg/min；最大 10 μg/kg/min。⚠️ >3 μg/kg/min 時有 cyanide 毒性；避免用於腎/肝功能不全；添加 thiosulfate 500 mg 到輸注液中。⚠️ 不推薦用於冠狀動脈缺血（冠狀動脈竊血）。 |

## Diuretic Therapy

**Table 18.4** 急性 Heart Failure 的利尿劑治療
...
| **Metolazone** | 增強 loop diuretic 的 thiazide。劑量：2.5–10 mg PO 每天，與 loop diuretic 間隔幾小時服用。⚠️ 組合增加低鉀血症風險。 |
...
1. Yancy CW, Jessup M, Bozkurt B, et al. 2013 ACCF/AHA guideline for the management of heart failure. J Am Coll Cardiol 2013; 62:e147–e239.
...
3. Heidenreich PA, Bozkurt B, Aguilar D, et al. 2022 AHA/ACC/HFSA guideline for the management of heart failure. J Am Coll Cardiol 2022; 79:e263–e421.
4. Maddox TM, Januzzi JL Jr, Allen LA, et al. Update to the 2021 ACC expert consensus decision pathway for optimization of heart failure treatment. J Am Coll Cardiol 2021; 77:772–810.
